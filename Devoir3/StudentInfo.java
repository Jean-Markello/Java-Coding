...
public class StudentInfo {
    ...
    */
    ...
    public static void display() {
        ...
        System.out.println("************************************************************");
        System.out.println("*     Number of team: 2                                    *");
        System.out.println("*     Jean Markello Létang,  300245679                     *");
        System.out.println("*     David McIntyre-Garcia, 300241605                     *");
        System.out.println("*     Section: Devoir 3                                    *");
        System.out.println("************************************************************");
        System.out.println();
