...
public class Utils {
	 ...
	 *  Reference to a 1 dimensional array of size columns x lines
	 */

	//This method return the index value base on the columns and the lines given for any tictactoe size (forming a square or not)
